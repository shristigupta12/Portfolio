...
const Contacts = () =>{
    return(
        <footer id="contacts" className="flex flex-col gap-18 text-neutral-700 w-full py-20 overflow-x-hidden">
            <ViewContainer className="grid gap-8">
                ...
                <div className="flex justify-between items-center  ">
                    <div className="flex gap-1 text-sm items-center max-md:text-xs">
                    ...
                    {ContactData.map((contact, index)=>(
                        <Link href={contact.link} key={index} target="_blank">
                            <Button className="flex gap-1 hover:text-neutral-500 max-md:px-1 max-md:py-0.5 ">
