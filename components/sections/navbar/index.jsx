...
const Navbar = ()=>{
    ...
    return(
        <ViewContainer className={cn("view-container sticky top-3 flex justify-start")} id="nav">
            <nav className="flex w-fit rounded-2xl backdrop-blur-sm bg-neutral-800 mt-3  p-2 max-[500px]:px-2 max-[500px]:py-2 items-center transition-all shadow-md shadow-neutral-400 ">
